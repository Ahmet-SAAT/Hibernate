...
public class RunnerSave14 {
    ...
    public static void main(String[] args) {
        ...
        session.update(student1); // persistent scope// Detached olmuş student1 objesini Persisted State'e alır
        session.merge(student1); // persistent scope// Detached olmuş student1 objesini Persisted State'e alır
